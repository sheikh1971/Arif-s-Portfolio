...
import { CheckCircle2, ChevronRight, Activity, Brain, Layout } from 'lucide-react';

export const Experience = () => {
  return (
    <section id="experience" className="py-24">
      <div className="max-w-7xl mx-auto px-6">
        <h2 className="text-3xl md:text-4xl font-headline font-bold mb-16 text-center">Work Experience</h2>
              ...
              <div className="md:w-2/3 space-y-8">
                ...
                <div className="glass p-8 rounded-2xl relative overflow-hidden group">
                  ...
                  <div className="grid md:grid-cols-2 gap-8 mb-8">
                    <div>
                      <p className="text-xs font-headline uppercase tracking-widest text-primary mb-3">Architectural Role</p>
                      <p className="font-medium mb-4">{exp.highlightProject.role}</p>
                      <p className="text-xs font-headline uppercase tracking-widest text-primary mb-3">Responsibilities</p>
                    ...
                    <div>
                      <p className="text-xs font-headline uppercase tracking-widest text-primary mb-3">System Components</p>
                      ...
                      <p className="text-xs font-headline uppercase tracking-widest text-primary mb-3">Core Impact</p>
                      <ul className="space-y-2">
